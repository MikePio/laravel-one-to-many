<header>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-dark text-white px-3 shadow-bottom">
            {{-- <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}"> --}}
            <a class="navbar-brand d-flex align-items-center" href="{{ Auth::check() ? url('admin') : url('/') }}">
